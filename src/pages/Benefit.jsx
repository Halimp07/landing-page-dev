...
const Benefit = () => {
  return (
    <div className="w-full section bg-teal-400 lg:my-[50px] md:my-[50px] my-5 lg:mx-auto md:mx-auto mx-0 relative">
      <div className="w-full relative py-[40px] lg:pr-[67px] md:pr-[67px] pr-0 overflow-hidden">
        ...
        <div className=" text-white lg:text-[27px] md:text-[27px] lg:mt-0 md:mt-0 mt-36 text-base lg:flex md:flex lg:justify-end md:justify-end lg:text-start md:text-start text-center font-extrabold lg:mr-10 md:mr-10 mr-0 font-[''] capitalize leading-loose tracking-wide relative z-20">
      ...
      <div className="bg-teal-400 absolute w-full top-0">
        <div className="lg:py-[40px] md:py-[40px] lg:pl-[100px] md:pl-[100px]">
          ...
          <div className="flex-col lg:mt-0 md:mt-0 mt-10 justify-start items-start gap-1 lg:inline-flex md:inline-flex">
            <div className="lg:w-96 md:w-96 w-44 h-36 flex-col lg:mx-0 md:mx-0 mx-auto justify-start items-start gap-1 lg:inline-flex md:inline-flex">
        ...
        <div className="2xl:w-[1600px] xl:w-[1324px] md:w-[1080px] w-full lg:h-16 md:h-16 h-44 absolute flex justify-between items-center z-20 left-1/2 transform -translate-x-1/2 top-1/2">
