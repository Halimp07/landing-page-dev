  ...
  return (
    ...
    >
      ...
      <div className="bg-teal-400 absolute w-full top-0">
        ...
        <div className="2xl:w-[1600px] xl:w-[1350px] lg:w-[1090px] md:w-[830px] w-full lg:h-9 md:h-16 h-[250px] absolute flex justify-between items-center z-20 left-1/2 transform -translate-x-1/2 top-1/2">
          <div
            data-aos="zoom-in"
            data-aos-duration="2000"
