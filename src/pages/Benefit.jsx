    ...
    >
      <div className="2xl:mx-0 xl:mx-20 lg:mx-0 md:mx-0 mx-5">
        <div className="w-full relative bg-teal-400 2xl:py-[40px] xl:py-[40px] lg:py-[40px] md:py-[40px] py-7 2xl:pr-[85px] xl:pr-[60px] lg:pr-[80px] md:pr-[50px] pr-0 overflow-hidden">
          ...
          <div className="bg-orange-400 w-full 2xl:ml-[45%] xl:ml-[38%] lg:ml-[41%] md:ml-[42%] absolute left-0 lg:top-0 md:top-0 bottom-0 lg:h-full md:h-full h-1/2 lg:-skew-x-[15deg] md:-skew-x-[15deg]-skew-x-0 z-10"></div>
          <div
            data-aos="fade-left"
            data-aos-duration="2000"
