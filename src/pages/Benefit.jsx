...
const Benefit = () => {
  ...
  return (
    ...
    >
      <div className="w-full relative py-[40px] lg:pr-[67px] md:pr-[50px] pr-0 overflow-hidden">
        <div className="lg:visible md:visible invisible bg-teal-400 xl:h-[45px] lg:h-[25px] md:h-[25px] w-full rotate-[105deg] absolute z-20 xl:left-[55%] lg:left-[45%] md:left-[47%] top-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        <div className="bg-orange-400 w-[100%] xl:ml-[50%] md:ml-[42%] absolute left-0 lg:top-0 md:top-0 bottom-0 lg:h-full md:h-full h-1/2 lg:-skew-x-[15deg] md:-skew-x-[15deg] -skew-x-0 z-10"></div>
        <div
          data-aos="fade-left"
          data-aos-duration="2000"
          className=" text-white lg:text-[27px] md:text-lg lg:mt-0 md:mt-0 mt-44 text-base lg:flex md:flex lg:justify-end md:justify-end lg:text-start md:text-start text-center font-extrabold lg:mr-10 md:mr-10 mr-0 font-['Inter'] capitalize leading-loose tracking-wide relative z-20"
        >
        ...
        {consultant.map((item) => (
          ...
          >
            <div>
              {item.textLabel && (
                <div className="lg:text-right md:text-right text-center text-white lg:text-lg md:text-sm text-sm font-normal font-['Inter'] capitalize leading-loose tracking-tight my-auto">
                  {item.textLabel}
                </div>
              )}
            </div>
      ...
      <div className="bg-teal-400 absolute w-full top-0">
        <div className="lg:py-[40px] md:py-[45px] lg:pl-[100px] md:pl-[50px]">
          <div
            data-aos="fade-right"
            data-aos-duration="3000"
            className="lg:py-2.5 md:py-1 py-2.5 left-0 top-0 absolute bg-white rounded-tr-full rounded-br-full flex-col justify-start items-start gap-2.5 inline-flex"
          >
            <img className="lg:w-20 md:w-16 w-20 h-6" src={eduskill_left} />
          </div>
        ...
        <div className="xl:w-[1600px] lg:w-[1090px] md:w-[830px] w-full lg:h-16 md:h-16 h-[215px] absolute flex justify-between items-center z-20 left-1/2 transform -translate-x-1/2 top-1/2">
          <div
            data-aos="zoom-in"
            data-aos-duration="2000"
