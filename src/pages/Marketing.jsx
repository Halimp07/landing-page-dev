      ...
      <div className="lg:section md:section">
        <div className="lg:flex md:flex">
          ...
          <div className="w-full flex-col lg:gap-6 md:gap-6 gap-3 inline-flex items-start">
            <div className="w-full lg:h-40 md:h-40 h-28 lg:px-4 md:px-4 px-3 py-9 bg-white rounded-2xl border border-neutral-300 justify-start items-center inline-flex">
