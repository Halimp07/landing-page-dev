    ...
    <div className="lg:mb-[50px] md:mb-[50px] mb-[30px] lg:flex md:flex justify-center lg:mx-0 md:mx-0 mx-[20px]">
      <div className="lg:section md:section">
        <div className="lg:flex md:flex">
          <div className="w-full lg:h-72 md:h-72 h-56 flex-col justify-start items-start lg:gap-6 md:gap-6 gap-3 inline-flex">
          ...
          <div className="w-full flex-col lg:gap-6 md:gap-6 gap-3 inline-flex items-start lg:mt-0 md:mt-0 mt-4">
