      ...
      <div className="lg:section md:section">
        <div className="lg:flex md:flex">
          <div className="w-full lg:h-72 md:h-72 h-full flex-col justify-start items-start lg:gap-6 md:gap-6 gap-3 inline-flex font-['Poppins']">
            <div className="lg:mr-20 md:mr-20 mr-14 text-orange-500 lg:text-3xl md:text-3xl text-lg font-bold lg:leading-10 md:leading-10 leading-1 lg:tracking-wide md:tracking-wide tracking-normal">
              Mengapa Eduskill menjadi Pilihan Terbaik untuk Upskilling?
            </div>
            <div className=" text-black lg:text-lg md:text-lg text-base text-start font-light leading-normal tracking-tight">
